...
import node_helpers
import nodes
from .runtime.text_encoder import LLaDAImageTEModel
from .runtime.loader import load_checkpoint
...
class SamplerLLaDAImageTurbo(io.ComfyNode):
    ...
    def define_schema(cls):
        return io.Schema(
            node_id="T8SamplerLLaDAImageTurbo",
...
class LLaDAImageVQConditioning(io.ComfyNode):
    ...
    def define_schema(cls):
        return io.Schema(
            node_id="T8LLaDAImageVQConditioning",
...
class LLaDAImageEditConditioning(io.ComfyNode):
    ...
    def define_schema(cls):
        return io.Schema(
            node_id="T8LLaDAImageEditConditioning",
...
class T8LLaDAImageCheckpointLoader(io.ComfyNode):
    ...
    def define_schema(cls):
        return io.Schema(
            node_id="T8LLaDAImageCheckpointLoader",
            display_name="LLaDA-Image AIO Loader (T8)",
            category="loaders/llada_image",
    ...
    def execute(cls, ckpt_name):
        ...
        return io.NodeOutput(*load_checkpoint(path, folder_paths.get_folder_paths("embeddings")))
